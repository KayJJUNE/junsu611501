    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        try:
            ...
            if character_name == "total":
                ...
                # TOP 10 유저 리스트를 DB에서 가져온 그대로 출력
                for i, (rank_user_id, affinity_val, messages_val) in enumerate(rankings[:10], 1):
            ...
            # --- 이하 eros, kagari 등 기존 캐릭터별 랭킹 코드는 건드리지 않음 ---
